...
public class DetailActivity extends AppCompatActivity implements Util.RequestListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //dto 에 담긴 회원 정보를 EditText 에 출력해 보세요.
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url="http://172.30.1.46:8888/spring04/api/member/update.do";
                //요청 파라미터를 Map 에 담는다.
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int num=dto.getNum();
                //웹서버에 요청할 url
                String url="http://172.30.1.46:8888/spring04/api/member/delete.do";
                //요청 파라미터를 Map에 담는다.
                Map<String, String> params=new HashMap<>();
                params.put("num",Integer.toString(num));
                //Util 을 이용해서 전송
    ...
    public void onSuccess(int requestId, Map<String, Object> result) {
        ...
        if(code !=200){ //응답 코드가 200이 아니면 실패이다.
        ...
        new AlertDialog.Builder(this)
                .setTitle("알림")
                .setMessage(msg)
                .setNeutralButton("알림", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //DetailActivity finish() 메소드를 호출해서
                        //DetailActivity 가 종료 되도록한다.
                        ...
                        //되기 때문에 업데이트된 회원 목록을 볼 수 있는 것이다.
                        finish();
                    }
                })
                .create()
